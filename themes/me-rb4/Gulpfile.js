...
gulp.task( 'wp-pot', [ 'clean:pot' ], () =>
	gulp.src( paths.php )
		...
		.pipe( wpPot( {
			...
			'destFile': 'me-rb4.pot',
			'package': 'me-rb4',
			'bugReport': 'http://themightyengine.com',
			'lastTranslator': 'Mighty Engine <jo@themightyengine.com>',
			'team': 'Team <jo@themightyengine.com>'
		} ) )
...
gulp.task( 'watch', function () {
	...
	browserSync( {
		...
		'proxy': 'rb4.dev',    // Use http://themightyengine.com:3000 to use BrowserSync.
		'watchOptions': {
